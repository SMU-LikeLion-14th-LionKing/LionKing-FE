...
export default function VoteCreatePage() {
  ...
  return (
    <div className="flex min-h-screen bg-white"><Sidebar /><main className="min-w-0 flex-1 px-6 py-10 lg:px-12"><div className="mx-auto max-w-[1090px]"><div className="flex items-center gap-3"><Image src="/icons/Sidebar/lion.svg" alt="" width={44} height={44} /><h1 className="text-4xl font-bold">라이온킹</h1></div>
