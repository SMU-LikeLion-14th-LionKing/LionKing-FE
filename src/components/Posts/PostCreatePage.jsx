...
export default function PostCreatePage() {
  ...
  return (
    <div className="flex min-h-screen bg-white"><Sidebar /><main className="min-w-0 flex-1 bg-white p-5 sm:p-8 lg:p-10"><div className="mx-auto w-full max-w-7xl"><div className="flex items-center gap-3"><Image src="/icons/Sidebar/lion.svg" alt="" width={45} height={45} /><h1 className="text-[36px] font-bold">라이온킹</h1></div><h2 className="mt-10 text-[32px] font-bold">{editId ? "게시글 수정" : "게시글 작성"}</h2>
